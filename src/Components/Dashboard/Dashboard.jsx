  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="sidebar">
        ...
        <nav>
          <ul>
            <li onClick={() => handleSectionClick('overview')} className={activeSection === 'overview' ? 'active' : ''}>Overview</li>
            <li onClick={() => handleSectionClick('tracking-log')} className={activeSection === 'tracking-log' ? 'active' : ''}>Tracking Log</li>
            <li onClick={() => handleSectionClick('expenses')} className={activeSection === 'expenses' ? 'active' : ''}>Expenses</li>
            <li onClick={() => handleSectionClick('ai-recommendations')} className={activeSection === 'ai-recommendations' ? 'active' : ''}>AI Recommendations</li>
            <li onClick={() => handleSectionClick('visualisation')} className={activeSection === 'visualisation' ? 'active' : ''}>Visualisation</li> {/* Visualisation link */}
            ...
            <li className="unhoverable"></li>
            <li className="unhoverable"></li>
            <li onClick={() => handleSectionClick('notifications')} className={activeSection === 'notifications' ? 'active' : ''}>Notifications</li>
            <li onClick={() => handleSectionClick('help')} className={activeSection === 'help' ? 'active' : ''}>Help</li>
